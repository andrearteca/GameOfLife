...
//        }
    ...
    func gerarProximaNova(matriz: inout [[Int]]){
        var newMatriz = [[Int]]()
...
//        }
    ...
    func verVizinhosCell(l: Int, c: Int, m1: [[Cell]]) -> Int{
    ...
    func gerarProximaCell(matriz: inout [[Cell]]){
        var newMatriz = [[Cell]]()
    ...
    //repetição que individualiza as linhas
        for linha in matriz.indices{
            ...
            for coluna in matriz[linha].indices{
                ...
                //variável que vai armazenar a quantidade de vizinhos de uma célula específica
                let neighbours = verVizinhosCell(l: linha, c: coluna, m1: matriz)
                
                //variável que vai armazenar o novo valor da célula
                var newCell: Cell = Cell(isAlive: false)
